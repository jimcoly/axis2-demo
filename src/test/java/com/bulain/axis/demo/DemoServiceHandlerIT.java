...
public class DemoServiceHandlerIT {
    private static EndpointReference targetEPR = new EndpointReference(
            "http://localhost:8082/axis2-demo/services/DemoService");
    ...
    public static void main(String[] args) {
        try {
            ...
            OMNamespace omNs = factory.createOMNamespace("http://springExample.org/example1", "example1");
